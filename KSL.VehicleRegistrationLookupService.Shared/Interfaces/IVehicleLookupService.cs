...
namespace MKS.VehicleRegistrationLookupService.Shared.Interfaces
{
    public interface IVehicleLookupService
    {
       ...
       Task<ServiceResult<EnhancedVehicleInformation>> VrmLookup(string vehicleRegistrationMark);
        /// <summary>
        ...
        /// <returns></returns>
        Task<ServiceResult<EnhancedVehicleInformation>> VrmLookup(string vehicleRegistrationMark, string vehicleIdentificationNumber);
        ...
        /// <param name="vehicleRegistrationMark">The registration of the vehicle</param>
        /// <returns>The base information of a vehicle</returns>
        Task<ServiceResult<BaseVehicleInformation>> BasicVrmLookup(string vehicleRegistrationMark);
    }
}
